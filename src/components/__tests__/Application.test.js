...
import { render, cleanup, waitForElement, fireEvent,prettyDOM, getByText, getAllByTestId, getByPlaceholderText,getByAltText,getByRole,getAllByRole, queryByText, queryByAltText} from "@testing-library/react";
...
describe("Application", ()=> {
  ...
  it("loads data, cancels an interview and increases the spots remaining for Monday by 1", async () => {
    ...
    expect(getByText(appointment, "Are you sure you would like to delete appointment?"));
  ...
  it("loads data, edits an interview and keeps the spots remaining for Monday the same", async () => {
    ...
    expect(getByPlaceholderText(appointment, "Enter Student Name")).toHaveProperty("value", "Lydia Miller-Jones");
